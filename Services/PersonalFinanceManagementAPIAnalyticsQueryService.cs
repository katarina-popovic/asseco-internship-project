...
{
	[ServiceContract]
	public class PersonalFinanceManagementAPIAnalyticsQueryService: IPersonalFinanceManagementAPIAnalyticsQueryService
	{	

		private readonly ILogger<PersonalFinanceManagementAPIAnalyticsQueryService> _logger;

		private readonly IBrokerFacade _eventBus;

		public PersonalFinanceManagementAPIAnalyticsQueryService(ILogger<PersonalFinanceManagementAPIAnalyticsQueryService> logger, IBrokerFacade eventBus)
		{
			_logger = logger;
			_eventBus = eventBus;
		}

		public virtual  System.Threading.Tasks.Task<Result<SpendingsByCategory>> SpendingsGetAsync (InvocationContext invocationContext, SpendingsGetHttpParams spendingsGetHttpParams)
		{
